...
public class Inventory {
	...
	public List<InventoryItem> getOrderByPrice() { 
		this.items.sort(new Comparator<InventoryItem>() {
				public int compare(InventoryItem ITEMS1, InventoryItem ITEMS2) {
					return (int)(ITEMS1.getItem().getPrice()- ITEMS2.getItem().getPrice()) * -1;
				}
		});
		return this.items;
	}
	...
	public List<InventoryItem> getOrderByWeight() { 
		this.items.sort(new Comparator<InventoryItem>() {
				public int compare(InventoryItem ITEMS1, InventoryItem ITEMS2) {
					return (int)(ITEMS1.getItem().getWeight()*100- ITEMS2.getItem().getWeight()*100) * -1;
				}
		});
		return this.items;
	}
	...
	public List<InventoryItem> getOrderByQty() { 
		this.items.sort(new Comparator<InventoryItem>() {
				public int compare(InventoryItem ITEMS1, InventoryItem ITEMS2) {
					return (int)(ITEMS1.getQty()- ITEMS2.getQty()) * -1;
				}
		});
		return this.items;
	}
